...
function getModelLiData(){
 ...
 // var otherSkillInput = document.forms["modelForm"]["otherSkillInput"].value
  ...
  // alert(otherSkillInput)
    if(selectedIndex == 0 ) {
      ...
      // btnEdit.className = 'frontendEdit'
      // document.getElementById('frontendEdit').appendChild(btnEdit)
 ...
 //      alert(selected)
       ...
       var node = document.createElement("LI");
        ...
        // btnDel.className = 'frontendD'
        // var del = document.getElementById('frontendDel').appendChild(btnDel)
